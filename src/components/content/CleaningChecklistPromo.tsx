...
export function CleaningChecklistPromo() {
  return (
    <section id="cleaning-buyers-checklist" className="mt-10 scroll-mt-24 card border-accent/30 bg-accent-soft/10">
      <h2 className="text-xl font-semibold text-ink">Commercial cleaning robot buyer&apos;s checklist</h2>
      <p className="mt-2 max-w-2xl text-sm text-ink-muted">
        Ten steps, a quick decision tree, and first-call vendor questions — formatted for facilities and
        procurement before demos.
      </p>
      <div className="mt-4 flex flex-wrap gap-3">
        <Link
          href={CLEANING_BUYERS_CHECKLIST_PATH}
